...
use `order-directory`;
/*
3)	Display the total number of customers based on gender who have placed orders of worth at 
least Rs.3000.
*/
...
*/
select category.cat_id,category.cat_name, min(t3.min_price) as Min_price,t3.pro_name from category inner join
...
on supplier_pricing.pricing_id inner join product on product.pro_id=supplier_pricing.pro_id
where `order`.ord_date>"2021-10-05";

/*
8)	Display customer name and gender whose names start or end with character 'A'.
*/
select cus_name,cus_gender from customer where cus_name like 'A%' or 
cus_name like '%A';
